...
public class ControladorLogin {
    ...
    public ModelAndView validarLogin(@ModelAttribute("datosLogin") DatosLogin datosLogin, HttpServletRequest request) {
        ...
        HashMap<String, String> validaciones = validarFormulario(datosLogin);
    ...
    private HashMap<String, String> validarFormulario(DatosLogin datosLogin) {
        HashMap<String, String> validaciones = new HashMap<>();
        if (datosLogin.getEmail() == null || datosLogin.getEmail().trim().equals("")) {
            validaciones.put("emailIncompleto", "Debe agregar un email de usuario!");
        }
        if (datosLogin.getPassword() == null || datosLogin.getPassword().trim().equals("")) {
