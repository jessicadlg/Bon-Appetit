...
INSERT INTO Producto(PRODUCTO_TIPO,ID_PRODUCTO,nombre, precio,ID_CATEGORIA,nombreImagen,cantidadMeGusta,descripcion,tiempoDeCoccion) VALUES
                                                                                                                                         ('Bebida',1,'Cerveza Stella Artois',150.0,1,"cerveza.webp",1,"Cerveza Stella Artois Lata de 473 ml.",NULL),
                                                                                                                                         ...
                                                                                                                                         ('Comida',5,'Pizza de Jamón',450.0,6,"pizza.webp",5,"La pizza de jamón con mozzarella huevo y aceitunas.No dejes de probarla!!",'30.00'),
                                                                                                                                         ('Comida',6,'Pizza de pepperoni',450.0,6,"pizza2.webp",2,"La auténtica pizza Pepperoni con tomate, queso, pepperoni y orégano sobre una fina masa y horneada en el horno de leña.",'20.00' ),
                                                                                                                                         ('Comida',7,'Fugazzeta Rellena',450.0,6,"pizza3.webp",5,"No hay una pizza más argentina que la fugazzeta rellena disfruta de esta delicia que incluye jamón cocido natural, doble mozzarella, cebolla blanca, provolone y aceite de oliva.",'20.00' ),
                                                                                                                                         ('Comida',8,'Pizza de Muzzarella',450.0,6,"pizza4.webp",1,"La pizza de mozzarella es la más clásica entre todas las recetas de pizzas. Es la que nos gusta a la mayoría. Es una receta compuesta por una masa baja y crocante con una cubierta de salsa de tomate, mozzarella, aceitunas y orégano.",'20.00' ),
                                                                                                                                         ...
                                                                                                                                         ('Comida',15,'Hamburguesa con Huevo',550.0,4,"hambur-huevo.webp",5,"Hamburguesa doble con jamón, huevo,lechuga,tomate,queso cheddar y pan con semillas. La mejor combinación de sabores!",'30.00' ),
                                                                                                                                         ...
                                                                                                                                         ('Comida',17,'Papas Fritas',350.0,5,"papas-fritas.webp",3,"Porción de papas grandes.No dejes de probarlas!!",'20.00' ),
