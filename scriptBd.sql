...
INSERT INTO Producto(PRODUCTO_TIPO,ID_PRODUCTO,nombre, precio,ID_CATEGORIA,nombreImagen,cantidadMeGusta,descripcion,tiempoDeCoccion) VALUES
                                                                                                                                         ...
                                                                                                                                         ('Comida',5,'Pizza de Jamon',450.0,7,"pizza.webp",2,"La pizza de jamón con mozzarella huevo y aceitunas.No dejes de probarla ",'30.00'),
                                                                                                                                         ...
                                                                                                                                         ('Comida',9,'Pizza Vegana',650.0,3,"pizza-vegana-tomate.webp",1,"",'30.00'),
                                                                                                                                         ('Comida',10,'Panqueque de Espinaca',450.0,3,"vegano-panqueque.webp",1,"",'30.00'),
                                                                                                                                         ('Comida',11,'Pizza Tropical',450.0,3,"pizza-tropical.webp",1,"",'30.00'),
                                                                                                                                         ('Comida',12,'Wrap vegetariano',350.0,4,"wrap-vegetariano.webp",3,"",'30.00'),
                                                                                                                                         ('Comida',13,'Ensalada mediterranea',350.0,4,"ensalada-mediterranea.webp",1,"",'20.00'),
                                                                                                                                         ('Comida',14,'Hamburquesa Jamon y queso',550.0,5,"hambur-jyq.webp",2,"Hamburguesa doble con jamón y queso con pan de semillas",'30.00'),
                                                                                                                                         ('Comida',15,'Hamburquesa con Huevo',550.0,5,"hambur-huevo.webp",2,"Hamburguesa doble con jamón, huevo,lechuga,tomate,queso cheddar y pan con semillas",'30.00' ),
                                                                                                                                         ...
                                                                                                                                         ('Comida',17,'Papas Fritas',350.0,6,"papas-fritas.webp",3,"Porción de papas grandes",'30.00' ),
